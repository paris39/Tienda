	...
	*/
	echo "<table id='cabecera3Product' class='cabecera3Product'>
		...
		<table name='result' id='resultProduct' class='resultProduct'>
			<tr>
				<td class='images' rowspan='1' width='32%'>
				...
				<td class='details' style='border-style: none;'>
	...
	echo "			<br />
				...
				<td style='border-style: none; text-align: center;'>
					<form method='post' name='modifyCall' action='./modifyProduct.php' target='_blank'>
						<input type='hidden' name='ID' id='ID' value='".$fila2[IDPRODUCTO]."' />
						<input type='submit' name='modificar' id='modificar' value='Modificar' title='Modificar producto: ".$fila2[DESCRIP]."' />
					</form>
				</td>
			</tr>
		</table>";
